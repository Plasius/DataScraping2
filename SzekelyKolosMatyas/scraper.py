...
def export(profiles, fileName, header):
    ...
    with open(fileName, "w", encoding="utf-8") as f:
        ...
        for prof in profiles:
            print(prof, file=f) #replace a csv formátum miatt van benne

# bejelentkezés
driver = webdriver.Chrome(service=Service("chromedriver.exe"))
login("vilsxftptoomuckrtm@sdvrecft.com", "asd1.2.3.", driver)
...
export(profiles, "profilok.csv", "name,position,exp_name,exp_company,exp_start_date,exp_end_date,study_name,study_institution,study_start_date,study_end_date,cert_name,cert_institution,cert_issued,cert_expires\n")